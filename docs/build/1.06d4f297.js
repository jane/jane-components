    ...
    298: function(e, t, n) {
      e.exports = (function() {
          ...
          if (e)
            for (var o = 0; o < e.length; ++o) {
              ...
              if (
                ...
                ;(r || (r = [])).push(
                  new MarkedSpan(a, i.from, l ? null : i.to)
                )
              }
            }
          return r
        ...
        var _,
          ...
          q =
            'oncopy' in (_ = elt('div')) ||
            (_.setAttribute('oncopy', 'return;'),
            'function' == typeof _.oncopy),
          X = null
        ...
        function buildLineContent(e, t) {
          ...
          for (var o = 0; o <= (t.rest ? t.rest.length : 0); o++) {
            ...
            ;(r.pos = 0),
              ...
              (r.map = [])
            var c = t != e.display.externalMeasured && lineNo(i)
            insertLineContent(i, r, getLineStyles(e, i, c)),
              i.styleClasses &&
        ...
        function buildCollapsedSpan(e, t, n, r) {
          ...
          o && e.map.push(e.pos, e.pos + t, o),
            ...
            o &&
              (e.cm.display.input.setUneditable(o), e.content.appendChild(o)),
            (e.pos += t),
            (e.trailingSpace = !1)
        }
          ...
          do {
            ...
            for (var r = 0; r < e.ops.length; r++) {
              ...
              if (o.cursorActivityHandlers)
                for (
                  ;
                  o.cursorActivityCalled < o.cursorActivityHandlers.length;
        ...
        function measureCharInner(e, t, n, r) {
          ...
          if (3 == l.nodeType) {
            for (var p = 0; p < 4; p++) {
              for (
                ;
                c && isExtendingChar(t.line.text.charAt(i.coverStart + c));
        ...
        function wrappedLineExtentChar(e, t, n, r) {
          ...
          var o = intoCoordSystem(e, t, measureCharPrepared(e, n, r), 'line')
            .top
        ...
        function replaceOneSelection(e, t, n, r) {
          ...
          ;(o[t] = n),
            setSelection(e, normalizeSelection(o, e.sel.primIndex), r)
        }
          ...
          if (i.markedSpans)
            for (var a = 0; a < i.markedSpans.length; ++a) {
              ...
              if (
                ...
                if (
                  o &&
                  (signal(l, 'beforeCursorEnter'), l.explicitlyCleared)
                ) {
                  if (i.markedSpans) {
                    --a
                    continue
        ...
        function markText(e, t, n, r, o) {
          ...
          if (
            ...
            if (
              ...
              (t.line != n.line &&
                conflictingCollapsedRange(e, n.line, t, n, i))
            )
              throw new Error(
        ...
        ;(ke.prototype = createObj(BranchChunk.prototype, {
          ...
          setGutterMarker: docMethodOp(function(e, t, n) {
            return changeLine(this, e, 'gutter', function(e) {
              ...
              return (
                (r[t] = n), !n && isEmpty(r) && (e.gutterMarkers = null), !0
              )
            })
          }),
        ...
        Fe.prototype.compare = function(e, t, n) {
          return (
            this.time + 400 > e && 0 == cmp(t, this.pos) && n == this.button
          )
        }
        var Be = {
            toString: function() {
        ...
        function applyTextInput(e, t, n, r, o) {
          ...
          for (var d = r.ranges.length - 1; d >= 0; d--) {
            ...
            var g = {
              ...
              origin:
                o || (s ? 'paste' : e.state.cutIncoming ? 'cut' : '+input'),
            }
            ...
            ;(e.prototype = {
              ...
              getScrollInfo: function() {
                ...
                return {
                  ...
                  width:
                    e.scrollWidth - scrollGap(this) - this.display.barWidth,
